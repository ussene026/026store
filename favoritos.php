   ...
   <body>
      ...
      <section class="products">
         ...
         <div class="wishlist-total">
            <p>Total: <span>$<?= $grand_total; ?> MZN</span></p>
            <a href="produtos.php" class="option-btn">Continuar</a>
            <a href="favoritos.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Deseja eliminar tudo dos favoritos?');">Eliminar</a>
         </div>
         -->
      </section>
